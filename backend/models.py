...
class SavedResume(Base):
    """
    Stores the user's customized resume configuration, including edits,
    target mode, chosen template, and section ordering.
    """
    ...
    template = Column(String, default="ats_friendly")
    resume_data = Column(Text, nullable=False)     # JSON string of the complete resume structure
